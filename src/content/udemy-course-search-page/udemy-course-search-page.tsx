...
import {onElementAddedAsync, waitForElmAsync} from "../../helpers/utils";

const isTest = true

// setTimeout(mountCouponBadgeAsync, 2000)

onElementAddedAsync('a[href^="/course/"]').then(courseContainerElements => {
  courseContainerElements.forEach((courseContainerEle) => {
    ...
    imageContainerEle.appendChild(getCouponAvailableBadgeElement('100% off'))
  })
})
